...
test("check nad reálným data/dossiers projde (222 balíčků včetně jany-kochove)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 222 dossier balíčků")), lines.join("\n"));
