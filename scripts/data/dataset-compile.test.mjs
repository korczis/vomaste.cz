...
test("check nad reálným data/dossiers projde (207 balíčků včetně znojemského vedení)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 207 dossier balíčků")), lines.join("\n"));
