...
test("check nad reálným data/dossiers projde (66 balíčků včetně jakub-kulhanek)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 66 dossier balíčků")), lines.join("\n"));
