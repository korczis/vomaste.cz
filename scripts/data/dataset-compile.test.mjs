...
test("check nad reálným data/dossiers projde (127 balíčků včetně aleny-hanakove)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 127 dossier balíčků")), lines.join("\n"));
