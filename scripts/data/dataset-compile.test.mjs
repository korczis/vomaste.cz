...
test("check nad reálným data/dossiers projde (232 balíčků včetně davida-stolpy)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 232 dossier balíčků")), lines.join("\n"));
