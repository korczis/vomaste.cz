...
test("check nad reálným data/dossiers projde (102 balíčků včetně martin-pecina)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 102 dossier balíčků")), lines.join("\n"));
