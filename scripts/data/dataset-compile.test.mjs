...
test("check nad reálným data/dossiers projde (152 balíčků včetně daniely-filipiove)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 152 dossier balíčků")), lines.join("\n"));
