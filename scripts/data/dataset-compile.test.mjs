...
test("check nad reálným data/dossiers projde (162 balíčků včetně jiriho-sediveho)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 162 dossier balíčků")), lines.join("\n"));
