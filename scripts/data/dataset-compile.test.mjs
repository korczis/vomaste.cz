...
test("check nad reálným data/dossiers projde (41 balíčků včetně jan-lipavsky)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 41 dossier balíčků")), lines.join("\n"));
