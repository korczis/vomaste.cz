...
test("check nad reálným data/dossiers projde (132 balíčků včetně daniely-kovarove)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 132 dossier balíčků")), lines.join("\n"));
