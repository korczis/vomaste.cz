...
test("check nad reálným data/dossiers projde (192 balíčků po merge větve government-representatives)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 192 dossier balíčků")), lines.join("\n"));
