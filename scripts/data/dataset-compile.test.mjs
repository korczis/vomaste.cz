...
test("check nad reálným data/dossiers projde (157 balíčků včetně vaclava-jehlicky)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 157 dossier balíčků")), lines.join("\n"));
