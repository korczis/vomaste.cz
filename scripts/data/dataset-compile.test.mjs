...
test("check nad reálným data/dossiers projde (142 balíčků včetně stefana-fuleho)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 142 dossier balíčků")), lines.join("\n"));
