...
test("check nad reálným data/dossiers projde (212 balíčků včetně znojemských radních)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 212 dossier balíčků")), lines.join("\n"));
