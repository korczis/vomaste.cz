...
test("check nad reálným data/dossiers projde (177 balíčků včetně libora-ambrozka)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 177 dossier balíčků")), lines.join("\n"));
