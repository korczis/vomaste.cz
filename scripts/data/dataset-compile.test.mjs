...
test("check nad reálným data/dossiers projde (97 balíčků včetně helena-valkova)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 97 dossier balíčků")), lines.join("\n"));
