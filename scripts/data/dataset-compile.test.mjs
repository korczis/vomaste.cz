...
test("check nad reálným data/dossiers projde (82 balíčků včetně pavel-blazek)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 82 dossier balíčků")), lines.join("\n"));
