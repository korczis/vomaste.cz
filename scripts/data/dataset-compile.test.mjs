...
test("check nad reálným data/dossiers projde (35 balíčků včetně pavel-drobil)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 35 dossier balíčků")), lines.join("\n"));
