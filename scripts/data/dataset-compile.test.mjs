...
test("check nad reálným data/dossiers projde (107 balíčků včetně jana-fischera)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 107 dossier balíčků")), lines.join("\n"));
