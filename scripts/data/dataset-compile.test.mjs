...
test("check nad reálným data/dossiers projde (147 balíčků včetně ivana-langera)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 147 dossier balíčků")), lines.join("\n"));
