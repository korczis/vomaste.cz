...
test("check nad reálným data/dossiers projde (112 balíčků včetně petra-necase)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 112 dossier balíčků")), lines.join("\n"));
