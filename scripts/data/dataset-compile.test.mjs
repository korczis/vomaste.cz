...
test("check nad reálným data/dossiers projde (87 balíčků včetně bohuslav-sobotka)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 87 dossier balíčků")), lines.join("\n"));
