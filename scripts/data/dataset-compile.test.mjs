...
test("check nad reálným data/dossiers projde (92 balíčků včetně svatopluk-nemecek)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 92 dossier balíčků")), lines.join("\n"));
