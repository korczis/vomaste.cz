...
test("check nad reálným data/dossiers projde (38 balíčků, martin-pavlik rozšířen)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 38 dossier balíčků")), lines.join("\n"));
