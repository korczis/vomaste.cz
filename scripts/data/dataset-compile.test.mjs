...
test("check nad reálným data/dossiers projde (172 balíčků včetně milana-urbana)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 172 dossier balíčků")), lines.join("\n"));
