...
test("check nad reálným data/dossiers projde (217 balíčků včetně znojemských zastupitelů)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 217 dossier balíčků")), lines.join("\n"));
