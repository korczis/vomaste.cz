...
test("check nad reálným data/dossiers projde (233 balíčků — kompletní znojemské zastupitelstvo)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 233 dossier balíčků")), lines.join("\n"));
