...
test("check nad reálným data/dossiers projde (122 balíčků včetně jana-kubiceho)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 122 dossier balíčků")), lines.join("\n"));
