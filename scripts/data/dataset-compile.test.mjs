...
test("check nad reálným data/dossiers projde (182 balíčků včetně jaroslava-palase)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 182 dossier balíčků")), lines.join("\n"));
