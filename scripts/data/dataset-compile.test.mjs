...
test("check nad reálným data/dossiers projde (81 balíčků včetně karla-slechtova)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 81 dossier balíčků")), lines.join("\n"));
