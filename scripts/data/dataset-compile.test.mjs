...
test("check nad reálným data/dossiers projde (167 balíčků včetně zdenka-skromacha)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 167 dossier balíčků")), lines.join("\n"));
