...
test("check nad reálným data/dossiers projde (227 balíčků včetně marcely-pribylove)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 227 dossier balíčků")), lines.join("\n"));
