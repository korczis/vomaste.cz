...
test("check nad reálným data/dossiers projde (117 balíčků včetně leose-hegera)", async () => {
  ...
  assert.ok(lines.some((l) => l.includes("Načteno 117 dossier balíčků")), lines.join("\n"));
