...
test("golden: počty záznamů per typ (snapshot 2026-08-02i: T-047, provázání grafu třetí dávka — 66 nových relations napříč igor-cerveny/ivan-bednarik/jaromir-zuna/boris-stastny z už existujících citovaných tvrzení)", () => {
...
test("golden: graf — uzly z entit, hrany z relations", () => {
  ...
  assert.equal(compiled.graph.edges.length, 246);
});
