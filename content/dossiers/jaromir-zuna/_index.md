...
Rozsah dle `AUTH-2026-07-30-N`: škrt 21 miliard z obranného rozpočtu 2026 a spor o plnění 2 % NATO včetně jeho vlastních vyjádření (e15), neodvysílaný rozhovor s prezidentem Pavlem — „cenzura“ je charakteristika opozice, nikdy tohoto webu (TN.cz), spor o volbu náčelníka Generálního štábu a publikované výzvy k rezignaci (Echo24), a premiérova publikovaná nespokojenost s koncepcí armády (Blesk). Vše je zpravodajství o politickém konfliktu — pozice se atribuují tomu, kdo je vyslovil.
...
| <a id="clm-04"></a>[CLM-04](@/dossiers/jaromir-zuna/claims/clm-04.md) | V rozhovoru pro e15.cz (duben 2026) Zůna odmítl, že by armáda trpěla nedostatkem peněz; prohlásil, že armáda 'nikdy nebyla v tak luxusní situaci', že výdaje na obranu jsou nejvyšší v historii a všechny podepsané strategické projekty vyzbrojování běží. | <span class="status-badge status-quote">CITACE</span> | [SRC-02](@/dossiers/jaromir-zuna/sources/src-02.md) |
| <a id="clm-05"></a>[CLM-05](@/dossiers/jaromir-zuna/claims/clm-05.md) | Zůna v rozhovoru pro e15.cz označil za slabiny resortu personální podstav armády, zanedbanou oblast dronů a roztříštěný bezpečnostní systém státu. | <span class="status-badge status-quote">CITACE</span> | [SRC-02](@/dossiers/jaromir-zuna/sources/src-02.md) |
| <a id="clm-06"></a>[CLM-06](@/dossiers/jaromir-zuna/claims/clm-06.md) | Zůna v České televizi (duben 2026) uvedl, že NATO Česku neuzná jako obranné výdaje zhruba 20 miliard korun na dopravní stavby, které do výkazů zahrnula předchozí vláda; podle metodiky NATO tak ČR v roce 2026 dosáhne jen asi 1,78 % HDP místo dvouprocentního závazku. | <span class="status-badge status-quote">CITACE</span> | [SRC-05](@/dossiers/jaromir-zuna/sources/src-05.md) |
| <a id="clm-07"></a>[CLM-07](@/dossiers/jaromir-zuna/claims/clm-07.md) | Premiér Babiš v květnu 2026 připustil, že Česko v letošním roce nejspíš nedosáhne závazku 2 % HDP na obranu. | <span class="status-badge status-quote">CITACE</span> | [SRC-12](@/dossiers/jaromir-zuna/sources/src-12.md) |
| <a id="clm-08"></a>[CLM-08](@/dossiers/jaromir-zuna/claims/clm-08.md) | Rozhovor prezidenta Petra Pavla pro armádní podcast Kamufláž měl vyjít 7. dubna 2026, ale zveřejněn nebyl; podle opozice a části médií do vydání zasáhlo ministerstvo obrany. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-06](@/dossiers/jaromir-zuna/sources/src-06.md) [SRC-07](@/dossiers/jaromir-zuna/sources/src-07.md) [SRC-08](@/dossiers/jaromir-zuna/sources/src-08.md) |
| <a id="clm-09"></a>[CLM-09](@/dossiers/jaromir-zuna/claims/clm-09.md) | Opoziční politici nezveřejnění rozhovoru charakterizovali jako cenzuru prezidenta: Josef Flek (STAN) mluvil o 'bezprecedentním pokusu o umlčení hlavy státu', Martin Kupka (ODS) o 'cenzuře v nejtvrdší podobě' a Matěj Ondřej Havel (TOP 09) žádal Zůnovu rezignaci. | <span class="status-badge status-quote">CITACE</span> | [SRC-06](@/dossiers/jaromir-zuna/sources/src-06.md) |
| <a id="clm-10"></a>[CLM-10](@/dossiers/jaromir-zuna/claims/clm-10.md) | Ministerstvo obrany a ministr Zůna obvinění z cenzury odmítli; podle Zůny šlo o porušení předpisů, protože armáda založila paralelní komunikační kanál bez dodržení směrnic, a jeho úřad podle něj o existenci videa neměl informace. | <span class="status-badge status-quote">CITACE</span> | [SRC-06](@/dossiers/jaromir-zuna/sources/src-06.md) [SRC-07](@/dossiers/jaromir-zuna/sources/src-07.md) |
| <a id="clm-11"></a>[CLM-11](@/dossiers/jaromir-zuna/claims/clm-11.md) | Rozhovor s prezidentem Pavlem armáda nakonec 20. dubna 2026 zveřejnila na svém YouTube kanálu; ještě předtím ho na Facebooku publikoval ministr zahraničí Petr Macinka (Motoristé). | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-07](@/dossiers/jaromir-zuna/sources/src-07.md) |
| <a id="clm-12"></a>[CLM-12](@/dossiers/jaromir-zuna/claims/clm-12.md) | Inspekce ministerstva obrany v červnu 2026 neprokázala, že by resort zveřejnění rozhovoru zakázal nebo že šlo o cílenou cenzuru; chyby konstatovala na obou stranách — u vedoucího komunikace generálního štábu (nový kanál bez oficiální žádosti) i u ministrova kabinetu (nedostatečná proaktivita). | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-08](@/dossiers/jaromir-zuna/sources/src-08.md) |
| <a id="clm-13"></a>[CLM-13](@/dossiers/jaromir-zuna/claims/clm-13.md) | Vláda v květnu 2026 vybrala generála Miroslava Hlaváče jako nástupce Karla Řehky ve funkci náčelníka Generálního štábu; ministr obrany Zůna jako jediný člen vlády hlasoval proti, což veřejně potvrdil premiér Babiš. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-10](@/dossiers/jaromir-zuna/sources/src-10.md) [SRC-09](@/dossiers/jaromir-zuna/sources/src-09.md) |
| <a id="clm-14"></a>[CLM-14](@/dossiers/jaromir-zuna/claims/clm-14.md) | Prezident Pavel podle prohlášení Kanceláře prezidenta republiky považoval Hlaváče za dobrého kandidáta a byl připraven ho do funkce jmenovat. | <span class="status-badge status-quote">CITACE</span> | [SRC-10](@/dossiers/jaromir-zuna/sources/src-10.md) |
| <a id="clm-15"></a>[CLM-15](@/dossiers/jaromir-zuna/claims/clm-15.md) | Bývalý ministr obrany a europoslanec Alexandr Vondra (ODS) prohlásil, že po hlasování proti novému náčelníkovi generálního štábu 'neexistuje jiné čestné řešení než okamžitě rezignovat', protože jmenování náčelníka je podle něj nejdůležitější rozhodnutí, které ministr obrany může ve funkci udělat. | <span class="status-badge status-quote">CITACE</span> | [SRC-09](@/dossiers/jaromir-zuna/sources/src-09.md) |
| <a id="clm-16"></a>[CLM-16](@/dossiers/jaromir-zuna/claims/clm-16.md) | Předseda SPD Tomio Okamura spekulace o konci ministra Zůny odmítl; uvedl, že Hlaváč není z pohledu SPD z hlediska vojenského kariérního řádu ideální kandidát a že politickou odpovědnost za jeho výběr nese premiér Babiš. | <span class="status-badge status-quote">CITACE</span> | [SRC-11](@/dossiers/jaromir-zuna/sources/src-11.md) |
| <a id="clm-17"></a>[CLM-17](@/dossiers/jaromir-zuna/claims/clm-17.md) | Babiš v květnu 2026 veřejně kritizoval Zůnovu koncepci armády slovy 'Plánovat do roku 2040 jen 32 tisíc vojáků, s tím určitě nejsem spokojen'; požadoval nábor minimálně 2 000 vojáků ročně a urychlení posilování protivzdušné obrany. | <span class="status-badge status-quote">CITACE</span> | [SRC-12](@/dossiers/jaromir-zuna/sources/src-12.md) |
| <a id="clm-18"></a>[CLM-18](@/dossiers/jaromir-zuna/claims/clm-18.md) | Zůnova koncepce podle Echo24 počítala s růstem armády ze současných zhruba 25 750 na 32 000 vojáků do roku 2040, tedy o přibližně 4 000 osob. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-12](@/dossiers/jaromir-zuna/sources/src-12.md) |
| <a id="clm-19"></a>[CLM-19](@/dossiers/jaromir-zuna/claims/clm-19.md) | Babiš a Zůna jednali o armádní koncepci opakovaně (květen a začátek června 2026); premiér deklaroval záměr vrátit se ke koncepci budování armády schválené za předchozí vlády ANO se zaměřením na alianční závazky u těžké a střední brigády. | <span class="status-badge status-quote">CITACE</span> | [SRC-13](@/dossiers/jaromir-zuna/sources/src-13.md) |
