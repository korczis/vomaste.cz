...
[[extra.timeline]]
date = "2025-02"
title = "FN Olomouc opouští mezinárodní studii PROFID EHRA (dle pozdějšího vyjádření nemocnice)"
...
[[extra.timeline]]
date = "2025-12"
title = "První medializace kauzy defibrilátorů (Seznam Zprávy)"
anchor = "kauza-defibrilatory"
dot = "dot-fact"
subjects = ["vojtech"]
...
[[extra.timeline]]
date = "2026-02"
title = "FN Olomouc upřesňuje policejní prověřování; Vojtěch ukládá infolinku a žádá zprávu, ředitele nechce odvolávat"
anchor = "kauza-defibrilatory"
dot = "dot-fact"
subjects = ["vojtech"]
...
[[extra.timeline]]
date = "2026-03"
title = "Ministerstvo podává trestní oznámení (17. 3.); komentáře kritizují ministrovu počáteční zdrženlivost"
anchor = "kauza-defibrilatory"
dot = "dot-fact"
subjects = ["vojtech"]
...
[[extra.timeline]]
date = "2026-05"
title = "Koaliční SPD (Síla, Okamura) veřejně kritizuje Vojtěchovu očkovací strategii a bonusy VZP"
anchor = "kauza-defibrilatory"
dot = "dot-fact"
subjects = ["vojtech"]
...
[[extra.timeline]]
date = "2026-06"
title = "Vojtěch ve Sněmovně hájí daňové zvýhodnění benefitů („vůbec netušil“); komentář Reflexu o střetu zájmů"
anchor = "kauza-defibrilatory"
dot = "dot-fact"
subjects = ["vojtech"]
...
[[extra.timeline]]
date = "2026-07"
title = "Debata o benefitech pokračuje ve Sněmovně; komise předběžně potvrzuje implantace ICD bez splnění kritérií"
anchor = "kauza-defibrilatory"
dot = "dot-fact"
subjects = ["vojtech"]
...
anchor = "kauza-defibrilatory"
period = "2026"
title = "Kauza defibrilátorů FN Olomouc"
...
anchor = "kauza-benefity-stret"
period = "2026"
title = "Daňové zvýhodnění benefitů a debata o střetu zájmů"
status = "status-single"
label = "Sledované téma"
...
anchor = "kauza-ockovani-spd"
period = "2026"
title = "Kritika očkovací strategie od koaliční SPD"
status = "status-single"
label = "Sledované téma"
...
Rozsah dle `AUTH-2026-07-30-Q`: kauza defibrilátorové studie FN Olomouc — reportovaná manipulace dokumentace, trestní oznámení z března 2026 a publikovaná kritika ministrovy počáteční zdrženlivosti (Seznam Zprávy) — oznámení míří na nemocniční věc, ne na ministra osobně, a toto rozlišení se drží explicitně; návrh daňového zvýhodnění zdravotních benefitů a publikovaná debata o střetu zájmů premiérových klinik (Reflex, Zdravotnický deník) — komentáře se označují jako komentáře; a publikovaná kritika očkovací strategie od koaliční SPD (Echo24).
...
| <a id="clm-04"></a>[CLM-04](@/dossiers/adam-vojtech/claims/clm-04.md) | Podstatou podezření je možné systémové obcházení indikačních kritérií při implantacích ICD, účelové úpravy zdravotnické dokumentace a nestandardní postupy při realizaci klinických studií. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-02](@/dossiers/adam-vojtech/sources/src-02.md) [SRC-03](@/dossiers/adam-vojtech/sources/src-03.md) |
| <a id="clm-05"></a>[CLM-05](@/dossiers/adam-vojtech/claims/clm-05.md) | Ministr Vojtěch k podání trestního oznámení uvedl: „Zjištění, která máme aktuálně k dispozici, jsou natolik závažná, že odůvodňují neprodlené prověření orgány činnými v trestním řízení.“ | <span class="status-badge status-quote">CITACE</span> | [SRC-02](@/dossiers/adam-vojtech/sources/src-02.md) [SRC-03](@/dossiers/adam-vojtech/sources/src-03.md) |
| <a id="clm-06"></a>[CLM-06](@/dossiers/adam-vojtech/claims/clm-06.md) | Policie v kauze prověřuje podezření z podvodu a těžkého ublížení na zdraví; prověřování se týká několika stovek pacientů a implantací provedených v období od roku 2015 do února 2025. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-03](@/dossiers/adam-vojtech/sources/src-03.md) [SRC-04](@/dossiers/adam-vojtech/sources/src-04.md) |
| <a id="clm-07"></a>[CLM-07](@/dossiers/adam-vojtech/claims/clm-07.md) | FN Olomouc se účastnila mezinárodní klinické studie PROFID EHRA, kterou opustila v únoru 2025; policie podle nemocnice prověřuje možné nesrovnalosti mezi zdravotnickou dokumentací pacientů a výsledky hlášenými zadavateli studie. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-04](@/dossiers/adam-vojtech/sources/src-04.md) |
| <a id="clm-08"></a>[CLM-08](@/dossiers/adam-vojtech/claims/clm-08.md) | V únoru 2026 ministr Vojtěch uložil FN Olomouc zřídit informační linku pro pacienty s implantovanými defibrilátory a vyžádal si komplexní zprávu s časovou osou a stavem interní revize; řešení personální odpovědnosti odložil na později. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-04](@/dossiers/adam-vojtech/sources/src-04.md), [SRC-33](@/dossiers/adam-vojtech/sources/src-33.md) |
| <a id="clm-09"></a>[CLM-09](@/dossiers/adam-vojtech/claims/clm-09.md) | Podle zpravodajství Seznam Zpráv ministr Vojtěch ještě v únoru 2026 neviděl důvod k odvolání dlouholetého ředitele FN Olomouc Romana Havlíka a premiér Babiš tehdy ředitele veřejně podpořil; trestní oznámení resort podal až v polovině března. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-02](@/dossiers/adam-vojtech/sources/src-02.md) |
| <a id="clm-10"></a>[CLM-10](@/dossiers/adam-vojtech/claims/clm-10.md) | Radek Kedroň v komentáři Seznam Zpráv (22. 3. 2026) ministrovi vytkl, že kolem kauzy dlouho „jen opatrně přešlapoval“, přehlédl varovné signály medializované už v prosinci a veřejně bránil vedení nemocnice („Stačilo číst noviny, pane ministre“). Jde o názorový text, hodnocení je autorovo. | <span class="status-badge status-quote">CITACE</span> | [SRC-05](@/dossiers/adam-vojtech/sources/src-05.md) |
| <a id="clm-11"></a>[CLM-11](@/dossiers/adam-vojtech/claims/clm-11.md) | Odborná komise (vzniklá z iniciativy FN Olomouc, vedená odborníkem pověřeným ministerstvem zdravotnictví) v předběžném stanovisku z července 2026 konstatovala, že v roce 2024 byly některým pacientům implantovány ICD, aniž byla zcela naplněna indikační kritéria. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-07](@/dossiers/adam-vojtech/sources/src-07.md) |
| <a id="clm-12"></a>[CLM-12](@/dossiers/adam-vojtech/claims/clm-12.md) | Aktuálně.cz popsalo případ pacienta, jemuž byl ve FN Olomouc implantován defibrilátor, přestože byl téhož dne převezen do hospicu; citovaný zdravotník uvedl: „Lékaři věděli, že umírá a defibrilátor nepotřebuje, přesto mu ho voperovali.“ | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-06](@/dossiers/adam-vojtech/sources/src-06.md) |
| <a id="clm-13"></a>[CLM-13](@/dossiers/adam-vojtech/claims/clm-13.md) | Ministr Vojtěch navrhuje daňové zvýhodnění vybraných zdravotních benefitů hrazených zaměstnavateli — zrušení ročního limitu 50 000 Kč pro daňové osvobození u vybraných preventivních programů (screening onkologických, kardiovaskulárních onemocnění a diabetu, dobrovolné očkování). | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-08](@/dossiers/adam-vojtech/sources/src-08.md) |
| <a id="clm-14"></a>[CLM-14](@/dossiers/adam-vojtech/claims/clm-14.md) | Poslankyně Michaela Šebelová (STAN) v souvislosti s návrhem upozornila, že premiér Babiš vlastní zdravotnické kliniky, které by z opatření profitovaly; podle ní nejde formálně o střet zájmů, ale fakticky ano. Ptala se, zda změna není „šita na míru“ klinikám z holdingu spojeného s premiérem. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-08](@/dossiers/adam-vojtech/sources/src-08.md), [SRC-22](@/dossiers/adam-vojtech/sources/src-22.md) |
| <a id="clm-15"></a>[CLM-15](@/dossiers/adam-vojtech/claims/clm-15.md) | Vojtěch ve Sněmovně uvedl, že „vůbec netušil“, že by kliniky z holdingu spojeného s Babišem prováděly onkologické prohlídky; návrh hájí tím, že impuls přišel od zaměstnavatelských svazů, jde o soukromé peníze firem a nastavení má být nediskriminační s volbou poskytovatele. | <span class="status-badge status-quote">CITACE</span> | [SRC-08](@/dossiers/adam-vojtech/sources/src-08.md) [SRC-09](@/dossiers/adam-vojtech/sources/src-09.md) |
| <a id="clm-16"></a>[CLM-16](@/dossiers/adam-vojtech/claims/clm-16.md) | Jiří Sezemský v komentáři Reflexu (12. 6. 2026) napsal, že ministr „si hraje na neználka“ — buď zvýhodňuje Babišovy kliniky vědomě, nebo je nekompetentní; uvádí, že holding SynBiol loni získal z veřejného zdravotního pojištění téměř tři miliardy Kč. Jde o komentář, tvrzení a hodnocení jsou autorova. | <span class="status-badge status-quote">CITACE</span> | [SRC-10](@/dossiers/adam-vojtech/sources/src-10.md) |
| <a id="clm-17"></a>[CLM-17](@/dossiers/adam-vojtech/claims/clm-17.md) | Návrh daňového zvýhodnění je předkládán jako poslanecký pozměňovací návrh, tedy mimo standardní vládní legislativní proces s meziresortním připomínkovým řízením. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-08](@/dossiers/adam-vojtech/sources/src-08.md) |
| <a id="clm-18"></a>[CLM-18](@/dossiers/adam-vojtech/claims/clm-18.md) | Zdravotnický expert koaliční SPD Jan Síla kritizoval ministra Vojtěcha slovy, že si k prosazování národní očkovací strategie „opět přizval osoby odpovědné za zmatky v covidové pandemii“, což je podle SPD příčinou nedůvěry veřejnosti v očkování. Jde o pozici koaliční strany SPD, nikoli o nezávislé zjištění. | <span class="status-badge status-quote">CITACE</span> | [SRC-11](@/dossiers/adam-vojtech/sources/src-11.md) |
| <a id="clm-19"></a>[CLM-19](@/dossiers/adam-vojtech/claims/clm-19.md) | Koaliční SPD žádá revokaci národní očkovací strategie (doporučená dobrovolná očkování proti covidu, HPV a chřipce), která podle Echo24 počítá s náklady 2–3 miliardy Kč; ministr Vojtěch strategii hájí. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-11](@/dossiers/adam-vojtech/sources/src-11.md) |
| <a id="clm-20"></a>[CLM-20](@/dossiers/adam-vojtech/claims/clm-20.md) | Vojtěch v reakci na kritiku odmítl, že by strategie zaváděla registr neočkovaných; tzv. signální kód pro vykazování odmítnutí povinného očkování podle něj existuje šest let a slouží jako ochrana lékařů. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-11](@/dossiers/adam-vojtech/sources/src-11.md) |
| <a id="clm-21"></a>[CLM-21](@/dossiers/adam-vojtech/claims/clm-21.md) | Předseda koaliční SPD Tomio Okamura označil bonusy VZP zaměstnavatelům za proočkovanost zaměstnanců proti chřipce (projekt „Zdravá firma“) za „uplácení zaměstnavatelů“ a nepřímý nátlak na zaměstnance. Jde o atribuovanou pozici koaliční strany. | <span class="status-badge status-quote">CITACE</span> | [SRC-12](@/dossiers/adam-vojtech/sources/src-12.md) |
...
Téma v autorizovaném rozsahu — viz tvrzení [CLM-13](@/dossiers/adam-vojtech/claims/clm-13.md), [CLM-14](@/dossiers/adam-vojtech/claims/clm-14.md), [CLM-15](@/dossiers/adam-vojtech/claims/clm-15.md), [CLM-16](@/dossiers/adam-vojtech/claims/clm-16.md), [CLM-17](@/dossiers/adam-vojtech/claims/clm-17.md) v registru výše. Stav vždy dle síly doložení u jednotlivých tvrzení.
