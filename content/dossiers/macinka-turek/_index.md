...
record_type = "dossier"
# "theme": one authorized dossier covering two subjects together, per
# AGENTS.md's actual authorization (a single joint dossier, never split
# into independent per-person dossiers without a separate, explicit,
# on-record authorization to do so — see scripts/dossier/validate-authorization.mjs).
dossier_type = "theme"
