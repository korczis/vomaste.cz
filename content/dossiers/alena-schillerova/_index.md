...
odkazem na jmenovaný, skutečně otevřený zdroj a se stavem podle síly
důkazu.

Rozsah pokrytí je dán autorizačním záznamem v `AGENTS.md`
(`AUTH-2026-07-30-B`): novela rozpočtových pravidel a stanovisko Národní
rozpočtové rady, včetně její vlastní publikované obhajoby. Nic dalšího
tento dossier nepokrývá.

## Registr tvrzení {#registr-tvrzeni}
| <a id="clm-08"></a>[CLM-08](@/dossiers/alena-schillerova/claims/clm-08.md) | Poslanecká sněmovna schválila novelu rozpočtových zákonů 15. května 2026 na mimořádné schůzi poměrem 91 hlasů pro a 68 proti; pro hlasovala vládní koalice, proti opozice. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-04](@/dossiers/alena-schillerova/sources/src-04.md), [SRC-20](@/dossiers/alena-schillerova/sources/src-20.md) |
...
| <a id="clm-13"></a>[CLM-13](@/dossiers/alena-schillerova/claims/clm-13.md) | Senát novelu 17. června 2026 po více než tříhodinové debatě vrátil Sněmovně s pozměňovacími návrhy: snížil limit pro vyjmuté infrastrukturní výdaje ze 2 % na 1 % HDP a podmínil navyšování výdajů souhlasem rozpočtového výboru. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-05](@/dossiers/alena-schillerova/sources/src-05.md), [SRC-23](@/dossiers/alena-schillerova/sources/src-23.md) |
| <a id="clm-14"></a>[CLM-14](@/dossiers/alena-schillerova/claims/clm-14.md) | Senát chtěl novelou omezit pravomoc ministerstva financí upravovat rozpočty nezávislých institucí, mezi něž patří Kancelář prezidenta republiky, Ústavní soud a veřejný ochránce práv. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-06](@/dossiers/alena-schillerova/sources/src-06.md), [SRC-26](@/dossiers/alena-schillerova/sources/src-26.md) |
| <a id="clm-15"></a>[CLM-15](@/dossiers/alena-schillerova/claims/clm-15.md) | Sněmovna přehlasovala Senát v nočním hlasování v noci na 8. července 2026 a potvrdila svou verzi novely přesně 101 hlasy vládní koalice, tedy minimálním potřebným počtem; všichni přítomní opoziční poslanci hlasovali proti. | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-06](@/dossiers/alena-schillerova/sources/src-06.md), [SRC-21](@/dossiers/alena-schillerova/sources/src-21.md) |
...
| <a id="clm-41"></a>[CLM-41](@/dossiers/alena-schillerova/claims/clm-41.md) | Předseda poslaneckého klubu ODS Martin Kupka 30. 7. 2026 uvedl, že ústavní stížnost proti novele je „ve finální fázi příprav“ (dosud nepodaná) a napadala by možnost zvýšení výdajů až o deset procent bez jasných podmínek, vágní bezpečnostní podmínky a rozšíření únikových doložek mimo obranu. | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-28](@/dossiers/alena-schillerova/sources/src-28.md) |
| ID | Tvrzení | Stav | Zdroje |
|---|---|---|---|
| <a id="clm-01"></a>[CLM-01](@/dossiers/alena-schillerova/claims/clm-01.md) | Alena Schillerová zastává podle oficiálního profilu na webu Úřadu vlády funkci místopředsedkyně vlády a ministryně financí | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-01](@/dossiers/alena-schillerova/sources/src-01.md), [SRC-24](@/dossiers/alena-schillerova/sources/src-24.md) |
| <a id="clm-02"></a>[CLM-02](@/dossiers/alena-schillerova/claims/clm-02.md) | Podle téhož profilu byla ministryní financí jmenována 17. 12. 2017 a místopředsedkyní vlády 30. 4. 2019; předtím působila jako náměstkyně ministra financí pro daně a celní správu (2016–2017) a ve Finanční správě od roku 1991 | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-01](@/dossiers/alena-schillerova/sources/src-01.md) |
| <a id="clm-03"></a>[CLM-03](@/dossiers/alena-schillerova/claims/clm-03.md) | Národní rozpočtová rada v lednu 2026 uvedla, že návrh státního rozpočtu na rok 2026 je v rozporu se zákonem o pravidlech rozpočtové odpovědnosti, a označila situaci za bezprecedentní; podle vlastního vyjádření rady měl být maximální přípustný schodek 246 miliard korun (základní rámec 237 miliard plus 9 miliard na obranu) místo navržených 310 miliard, zatímco citované zpravodajství uvádělo 247 miliard. Jde o stanovisko nezávislého odborného orgánu, ne o soudní rozhodnutí | <span class="status-badge status-corroborated">CORROBORATED</span> | [SRC-02](@/dossiers/alena-schillerova/sources/src-02.md), [SRC-18](@/dossiers/alena-schillerova/sources/src-18.md) |
| <a id="clm-04"></a>[CLM-04](@/dossiers/alena-schillerova/claims/clm-04.md) | Schillerová podle citovaného zpravodajství namítla, že výdajové limity se vztahují jen na rozpočty projednávané v běžném září­ovém termínu, ne na přepracované verze po zamítnutí Sněmovnou; ministerstvo zároveň rozporovalo výpočet rady s tím, že obranné výdaje 55 miliard odůvodňují limit 292 miliard | <span class="status-badge status-quote">CITACE</span> | [SRC-02](@/dossiers/alena-schillerova/sources/src-02.md) |
| <a id="clm-05"></a>[CLM-05](@/dossiers/alena-schillerova/claims/clm-05.md) | Novela rozpočtových zákonů mění výpočet výdajových rámců z pravidla maximálního strukturálního deficitu na střednědobý růst čistých výdajů; podle citovaného zpravodajství by pozměňovací návrhy ministryně umožnily navýšit výdaje na strategickou infrastrukturu nad schválené limity a v některých případech obejít schválení Parlamentem, včetně navýšení až o 10 procent při bezpečnostních hrozbách | <span class="status-badge status-single">1 ZDROJ</span> | [SRC-03](@/dossiers/alena-schillerova/sources/src-03.md), [SRC-22](@/dossiers/alena-schillerova/sources/src-22.md) |
| <a id="clm-06"></a>[CLM-06](@/dossiers/alena-schillerova/claims/clm-06.md) | Schillerová novelu obhájila slovy „Neexistuje realistický scénář, jak za rok snížit deficit na 150 miliard korun bez kolapsu investic" a argumentovala, že rozpočtová pravidla předchozí vlády vytvořila neřešitelnou situaci | <span class="status-badge status-quote">CITACE</span> | [SRC-03](@/dossiers/alena-schillerova/sources/src-03.md) |
| <a id="clm-07"></a>[CLM-07](@/dossiers/alena-schillerova/claims/clm-07.md) | Předseda ODS Martin Kupka označil novelu za „ústavní převrat na splátky" s tím, že přesouvá moc z Parlamentu na exekutivu; Olga Richterová (Piráti) uvedla, že zákon může vést ke „kolapsu státu". Jde o politické hodnocení oponentů, ne o zjištění kontrolního orgánu | <span class="status-badge status-quote">CITACE</span> | [SRC-03](@/dossiers/alena-schillerova/sources/src-03.md) |

## Kdo to je a čím je pokryt {#kdo}

Základní identifikace subjektu a rozsah pokrytí jsou popsané v úvodu této
stránky výše; podrobná kariéra následuje.

## Veřejná kariéra {#verejna-kariera}

Podle oficiálního profilu na webu Úřadu vlády
([SRC-01](@/dossiers/alena-schillerova/sources/src-01.md)) je Schillerová
právnička (JUDr. 1988, Ph.D. ze správního práva 2000, Masarykova
univerzita). Ve Finanční správě působila od roku 1991, v letech 2014–2015
jako ředitelka odboru právního a daňového procesu na Generálním finančním
ředitelství, v letech 2016–2017 jako náměstkyně ministra financí pro daně
a celní správu. Ministryní financí byla jmenována 17. 12. 2017,
místopředsedkyní vlády 30. 4. 2019
([CLM-02](@/dossiers/alena-schillerova/claims/clm-02.md)).

Dossier zaznamenává tato data jako úřední údaje, ne jako hodnocení jejího
výkonu funkce.

## Rozpočtová pravidla a stanovisko Národní rozpočtové rady {#kauza-rozpoctova-pravidla}

V lednu 2026 Národní rozpočtová rada uvedla, že návrh státního rozpočtu
na rok 2026 je v rozporu se zákonem o pravidlech rozpočtové odpovědnosti
([CLM-03](@/dossiers/alena-schillerova/claims/clm-03.md),
[SRC-02](@/dossiers/alena-schillerova/sources/src-02.md)). Je nutné
rozlišit dvě věci, které se v debatě slévají: stanovisko rady je
**posouzení nezávislého odborného orgánu**, ne pravomocné rozhodnutí
soudu o porušení zákona. Dossier tedy neuvádí, že zákon porušen byl —
uvádí, že to rada ve svém stanovisku konstatovala.

Ministerstvo a ministryně výpočet rady rozporovaly a uvedly vlastní
čísla ([CLM-04](@/dossiers/alena-schillerova/claims/clm-04.md)). Dossier
vede obě čísla vedle sebe (246 miliard podle vlastního vyjádření rady,
247 podle zpravodajství, proti 292 miliardám podle ministerstva),
protože spor o výpočet nebyl v citovaných zdrojích uzavřen.

V květnu 2026 Sněmovna projednávala novelu rozpočtových zákonů, která
mění způsob výpočtu výdajových rámců
([CLM-05](@/dossiers/alena-schillerova/claims/clm-05.md),
[SRC-03](@/dossiers/alena-schillerova/sources/src-03.md)). Ministryně ji
obhajovala tím, že bez změny nelze sestavit zákonný rozpočet
([CLM-06](@/dossiers/alena-schillerova/claims/clm-06.md)); opozice ji
označila za přesun moci z Parlamentu na exekutivu
([CLM-07](@/dossiers/alena-schillerova/claims/clm-07.md)). Obě strany
jsou vedeny jako citované výroky, ne jako zjištění tohoto webu.

## Co tento přehled nezkoumal {#mezery}

Otevřené mezery vede [registr mezer](@/dossiers/alena-schillerova/gaps/_index.md):
osud novely po květnovém projednávání
([GAP-01](@/dossiers/alena-schillerova/gaps/gap-01.md)) a rozpor ve
výpočtu přípustného schodku, který citované zdroje neuzavřely
([GAP-02](@/dossiers/alena-schillerova/gaps/gap-02.md)).

## Metodické omezení

Tento dossier není hodnocením viny, kompetence ani politické správnosti.
Zachycuje pouze to, co k uvedenému datu uvedly citované, skutečně
