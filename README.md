...
→ verify:navigation-counts / verify:anchors / verify:jsonld / verify:full-pages / verify:export
...
│                           #  manifest, mapa, /data/ a per-dossier evidence//entities/
│                           #  indexy; generované mimo staging: /zdroje/, entities/typ/)
