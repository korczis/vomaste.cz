...
- **Fáze**: A–I hotové (baseline, schémata + context, kompilátor,
  lossless migrátor, adaptéry, view modely, přepojení generátorů,
  ODSTRANĚNÍ STARÝCH ZDROJŮ PRAVDY, contributor tooling + dokumentace);
  J (finální parity gate) navazuje. Tento dokument se po každé fázi
