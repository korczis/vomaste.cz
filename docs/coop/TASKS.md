...
|----|-------|-----------------------|--------|-------|------|------------|-----------|
| T-018 | Fáze 4 — `/dossiers/` directory jako hustá sortable tabulka + dossier overview: kompaktní header, metric strip, view tabs, syntéza místo kopie registru | templates/dossiers-index.html, templates/entity-dossier.html, templates/dossier.html, macros | task/T-018 | W-9 | claimed | T-017 | mise § 6.1/6.2 (docs/missions/2026-07-30-workbench-master-prompt.md); ověřeno 2026-08-01 stále otevřené (dossiers-index.html zatím nepoužívá views::projection/advanced_table pattern, který mají ostatní registry) |
