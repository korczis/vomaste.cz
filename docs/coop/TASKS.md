...
| T-039b | `[scope-check]` Kolo rešerší, dávka 1b (zbytek po rozštěpení T-039): richard-chlad, petr-pavel, petr-vencalek, tunde-bartha | `data/dossiers/{richard-chlad,petr-pavel,petr-vencalek,tunde-bartha}/**` | task/T-039 | worker (worktree agent-ac64302a3f061c66d) | claimed | – | žádné nové téma/subjekt nad rámec AGENTS.md logu; každý zdroj přímo otevřen; `npm run build` zelený |
