...
120 příkazů celkem: 95 npm skriptů, 9 skills, 16 just receptů. 44 z nich může shodit běh, 41 jsou krokem `npm run build` a 9 běží v pre-commit hooku.
