...
182 příkazů celkem: 109 npm skriptů, 40 skills, 6 subagentů, 11 workflow, 16 just receptů. 57 z nich může shodit běh, 49 jsou krokem `npm run build` a 12 běží v pre-commit hooku.
