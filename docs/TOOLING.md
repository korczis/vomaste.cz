...
123 příkazů celkem: 98 npm skriptů, 9 skills, 16 just receptů. 47 z nich může shodit běh, 43 jsou krokem `npm run build` a 9 běží v pre-commit hooku.
