...
| Dossierů | 27 |
| Tvrzení | 972 |
| — z toho `E0` / `E1` / `E1+` / `E2` | 0 / 556 / 92 / 324 |
| Zdrojů (z toho s vyplněnou `sourceFamily`) | 708 (391) |
| Kauz | 94 |
...
| 27 | [Petr Macinka](../data/dossiers/petr-macinka/) `petr-macinka` *(view)* | **žádná** | 0 | 0.0 % | 100.0 % | 0 | 0/0/0/0 | 0 | 0 | 2026-07-29 |
